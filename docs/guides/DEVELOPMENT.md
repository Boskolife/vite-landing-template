...
Это руководство описывает процесс разработки проекта Vite Landing Template, включая настройку окружения, рабочий процесс, стандарты кодирования и лучшие практики.
